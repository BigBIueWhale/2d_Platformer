...
Map::Map()
{
    ...
    floor_ul_basic_sprite_.setPosition(200,200);
    ...
    floor_um_basic_sprite_.setPosition(200+floor_ul_basic_sprite_.getGlobalBounds().width,200);
    ...
    floor_ur_basic_sprite_.setPosition(200+floor_ul_basic_sprite_.getGlobalBounds().width+floor_um_basic_sprite_.getGlobalBounds().width,200);
    ...
    floor_ml_basic_sprite_.setPosition(200,200+floor_ur_basic_sprite_.getGlobalBounds().height);
    ...
    floor_mm_basic_sprite_.setPosition(200+floor_ul_basic_sprite_.getGlobalBounds().width,200 + floor_ur_basic_sprite_.getGlobalBounds().height);
    ...
    floor_mr_basic_sprite_.setPosition(200+(floor_ul_basic_sprite_.getGlobalBounds().width*2),200 + floor_ur_basic_sprite_.getGlobalBounds().height);
    ...
    floor_bl_basic_sprite_.setPosition(200,200+(floor_ur_basic_sprite_.getGlobalBounds().height)*2);
    ...
    floor_bm_basic_sprite_.setPosition(200+floor_ul_basic_sprite_.getGlobalBounds().width,200+(floor_ur_basic_sprite_.getGlobalBounds().height)*2);
    ...
    floor_br_basic_sprite_.setPosition(200+(floor_ul_basic_sprite_.getGlobalBounds().width*2),200+(floor_ur_basic_sprite_.getGlobalBounds().height)*2);
        ...
        for (int i = 0; i < rows; i++) {
            for (int j = 0; j < cols; j++) {
                ...
                if(letter == 'q')
                {
                    ...
                    map_vector.emplace_back(floor_ul_basic_sprite_);
                }
                else if(letter == 'w')
                {
                    floor_um_basic_sprite_.setPosition(j*38.4,i*38.4);
                    map_vector.emplace_back(floor_um_basic_sprite_);
                }
                else if(letter == 'e')
                {
                    floor_ur_basic_sprite_.setPosition(j*38.4,i*38.4);
                    map_vector.emplace_back(floor_ur_basic_sprite_);
                }
                else if(letter == 'a')
                {
                    floor_ml_basic_sprite_.setPosition(j*38.4,i*38.4);
                    map_vector.emplace_back(floor_ml_basic_sprite_);
                }
                else if(letter == 's')
                {
                    floor_mm_basic_sprite_.setPosition(j*38.4,i*38.4);
                    map_vector.emplace_back(floor_mm_basic_sprite_);
                }
                else if(letter == 'd')
                {
                    floor_mr_basic_sprite_.setPosition(j*38.4,i*38.4);
                    map_vector.emplace_back(floor_mr_basic_sprite_);
                }
                else if(letter == 'z')
                {
                    floor_bl_basic_sprite_.setPosition(j*38.4,i*38.4);
                    map_vector.emplace_back(floor_bl_basic_sprite_);
                }
                else if(letter == 'x')
                {
                    floor_bm_basic_sprite_.setPosition(j*38.4,i*38.4);
                    map_vector.emplace_back(floor_bm_basic_sprite_);
                }
                else if(letter == 'c')
                {
                    floor_br_basic_sprite_.setPosition(j*38.4,i*38.4);
                    map_vector.emplace_back(floor_br_basic_sprite_);
                }
            }
        }
...
//    window.draw(background_sprite_);
    ...
    for(const sf::Sprite &el : map_vector)
    {
        window.draw(el);
    }
